...
export const destinations: Destination[] = [
  {
    ...
    image: "/images/safari/elephants-impala-waterhole.jpg",
    heroImage: "/images/safari/victoria-falls-wide.jpg",
    highlights: ["Victoria Falls", "Hwange National Park", "Mana Pools", "Matobo National Park", "Great Zimbabwe Ruins"],
    ...
    longDescription: "Zimbabwe is one of Africa's most extraordinary safari destinations. Renowned for the finest professional guides on the continent, vast and uncrowded wilderness areas, and wildlife encounters that feel genuinely wild. From the towering spray of Victoria Falls to the remote walking trails of Hwange and Mana Pools, every corner of Zimbabwe offers a different dimension of the African experience.",
    activities: [],
    accommodation: [],
    wildlife: ["Elephant", "Lion", "Wild Dog", "Leopard", "Rhino"],
    coordinates: { lat: -19.0154, lng: 29.1549 },
    knownPlaces: ["Zimbabwe", "Victoria Falls", "Hwange National Park", "Bulawayo", "Matobo National Park", "Great Zimbabwe", "Harare", "Mana Pools", "Lake Kariba", "Matopos"]
  },
  {
    slug: "botswana",
    name: "Botswana",
