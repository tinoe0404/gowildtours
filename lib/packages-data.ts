...
const packagesData: Package[] = [
    ...
    {
        id: "10",
        slug: "6-days-victoria-falls-livingstone-and-chobe",
        title: "6 Days Victoria Falls, Livingstone and Chobe",
        category: ["Adventure", "Wildlife Safari", "Cultural Tour"],
        destinations: ["Victoria Falls", "Livingstone", "Chobe National Park"],
        shortDescription:
            "This 6-day safari combines Victoria Falls from both sides, Livingstone Museum, rhino tracking in Mosi-oa-Tunya, and a full-day Chobe safari across three countries.",
        longDescription:
            "This 6-day safari begins in Victoria Falls, where you arrive and enjoy a relaxing sunset dinner cruise on the mighty Zambezi River. On day two, experience a guided tour of the majestic Victoria Falls from the Zimbabwe side before crossing into Livingstone. Day three explores Livingstone with a visit to the Livingstone Museum, followed by a guided tour of the Falls from the Zambia side. On day four, enjoy rhino tracking in Mosi-oa-Tunya National Park before returning to Zimbabwe. Day five takes you on a full-day safari in Chobe National Park, famous for its large elephant herds and rich wildlife, including a river cruise and game drive. On day six, you depart from Victoria Falls, concluding a diverse journey that combines natural wonders, cultural experiences, and unforgettable wildlife encounters across Zimbabwe, Zambia, and Botswana.",
        duration: { days: 6, nights: 5 },
        groupSize: { min: 1, max: 12, type: "Small Group" },
        difficulty: "Easy",
        price: 3950,
        ...
        inclusions: [
            "5 nights accommodation in Victoria Falls and Livingstone",
            "All meals as per itinerary (breakfast, lunch, and dinner)",
            "Sunset dinner cruise on the Zambezi River",
            "Guided tours of Victoria Falls (Zimbabwe and Zambia sides)",
            "Visit to Livingstone Museum",
            "Rhino tracking in Mosi-oa-Tunya National Park",
            "Full-day safari in Chobe National Park (game drive and boat cruise)",
            "All park entry fees and conservation fees",
            "Bottled mineral water during activities and transfers",
            "Professional English-speaking safari guides",
            "All transfers in luxury air-conditioned vehicles",
            "4x4 safari vehicles for game drives in Chobe",
            "Return transfers between Zimbabwe, Zambia, and Botswana borders",
            "Airport pick-up and drop-off at Victoria Falls",
        ],
        exclusions: [
            "International and domestic flights",
            "Visa fees for Zimbabwe, Zambia, and Botswana",
            "Travel insurance (highly recommended)",
            "Tips and gratuities for guides, drivers, and lodge staff",
            "Alcoholic beverages and soft drinks (unless specified)",
            "Optional activities (e.g., helicopter flight over Victoria Falls, bungee jumping, etc.)",
            "Personal expenses (souvenirs, curio shopping, etc.)",
            "Laundry services",
        ...
        highlights: [
            "Sunset dinner cruise on the Zambezi River",
            "Guided tour of the spectacular Victoria Falls (Zimbabwe side)",
            "Cross-border experience between Zimbabwe and Zambia",
            "Visit to the Livingstone Museum",
            "Guided tour of Victoria Falls (Zambia side)",
            "Rhino tracking safari in Mosi-oa-Tunya National Park",
            "Scenic transfer back to Victoria Falls",
            "Full-day safari in Chobe National Park",
            "Chobe River boat cruise with excellent wildlife viewing",
            "Game drive in Chobe, famous for large elephant herds",
            "Opportunity to see diverse wildlife including elephants, lions, buffalo, and hippos",
            "Multi-country safari experience (Zimbabwe, Zambia & Botswana)",
        ],
        itinerary: [
            {
                day: 1,
                title: "Victoria Falls (Zimbabwe)",
                description: "Arrival at Victoria Falls International Airport — you will be welcomed by our safari guide then transferred to your overnight accommodation. Later afternoon we will do Dinner cruise on the Zambezi River. Victoria Falls is also known as Mosi-oa-Tunya which means \"The Smoke That Thunders\" in the local Tonga language, highlighting the powerful mist and noise created by the falls. The mist from the falls creates a unique microclimate, supporting a rainforest ecosystem on the surrounding cliffs.",
                route: "Victoria Falls International Airport to your overnight accommodation — 21km — 30 minutes",
                accommodation: "Insika Lodge or similar",
                meals: "Lunch, Dinner, Breakfast",
                highlights: "Dinner cruise",
            },
            {
                day: 2,
                title: "Livingstone",
                description: "After breakfast we depart hotel to Zambia but enroute we do Victoria Falls guided tour on the Zimbabwe side. Livingstone, the adventure capital of Zambia, is a vibrant gateway to the majestic Victoria Falls, one of the Seven Natural Wonders of the World. Rich in history and culture, the town offers thrilling activities such as white-water rafting, helicopter flights, sunset cruises on the Zambezi River, and wildlife encounters in Mosi-oa-Tunya National Park. Its warm hospitality, bustling markets, and colonial charm make Livingstone an ideal destination for explorers seeking authentic African experiences blended with world-class adventure.",
                route: "Victoria Falls to Livingstone — 20km",
                accommodation: "Protea Hotel Livingstone or similar",
                meals: "Lunch, Dinner, Breakfast",
                highlights: "Victoria Falls guided tour in Zimbabwe side and Livingstone Museum",
            },
            {
                day: 3,
                title: "Livingstone",
                ...
                accommodation: "Protea Hotel Livingstone or similar",
                meals: "Lunch, Dinner, Breakfast",
                highlights: "Guided tour of the Falls in Zambia side",
                optionalActivities: "Rafting, animal interactions and many more",
            },
            {
                day: 4,
                title: "Victoria Falls",
                description: "Victoria Falls is also known as Mosi-oa-Tunya which means \"The Smoke That Thunders\" in the local Tonga language, highlighting the powerful mist and noise created by the falls. The mist from the falls creates a unique microclimate, supporting a rainforest ecosystem on the surrounding cliffs. After breakfast we checked out then off to rhino tracking then after cross over to Zimbabwe.",
                route: "Livingstone to Victoria Falls — 20km — 1 hour",
                accommodation: "Insika Lodge or similar",
                meals: "Lunch, Dinner, Breakfast",
                highlights: "Rhino tracking (Walking safaris) in Mosi-oa-Tunya National Park before crossing to Zimbabwe",
            },
            {
                day: 5,
                title: "Chobe Day Tour",
                ...
                accommodation: "Insika Lodge or similar",
                meals: "Lunch, Dinner, Breakfast",
                highlights: "Mid-morning boat cruise, lunch and game drive (Full day Chobe tour)",
            },
            {
                day: 6,
                title: "Victoria Falls — Departure",
    ...
    {
        id: "14",
        slug: "8-days-namibia-etosha-ocean-and-desert",
        title: "8 Days Namibia-Etosha, Ocean and Desert",
        category: ["Adventure", "Wildlife Safari", "Cultural Tour"],
        destinations: ["Windhoek", "Etosha National Park", "Swakopmund", "Namib Desert", "Sossusvlei"],
        shortDescription:
            "This 8-day Namibia tour offers a spectacular journey through the country's most iconic landscapes — Etosha game drives, Swakopmund coast, and Sossusvlei dunes.",
        longDescription:
            "This 8-day Namibia tour offers a spectacular journey through the country's most iconic landscapes. Starting in Windhoek, the capital, travelers explore its cultural sites before heading north to Etosha National Park for thrilling game drives, spotting elephants, lions, giraffes, and rare antelope against vast salt pans. The tour continues to visit Swakopmund on the Atlantic coast, offering adventure activities and a taste of German colonial architecture. The journey then moves to the iconic Sossusvlei in the Namib Desert, where towering red dunes and Deadvlei create surreal landscapes. The tour concludes with a scenic return to Windhoek, combining wildlife, history, culture, and desert vistas in one unforgettable Namibian adventure.",
        ...
        inclusions: [
            "7 nights accommodation in carefully selected lodges, guesthouses, or camps",
            "All meals: Breakfast, lunch, and dinner as per itinerary",
            "Comfortable air-conditioned vehicles for transfers, road travel, and excursions",
            "Experienced guides for game drives, cultural visits, and sightseeing",
            "Windhoek city tour – cultural and market visits",
        ...
        highlights: [
            ...
            "Desert scenery and landscapes: Experience the Namib Desert, Damaraland, and rugged terrain",
            "Cultural and scenic stops: Learn about local communities and enjoy panoramic views",
            "This tour combines wildlife, culture, adventure, and dramatic natural scenery",
        ],
        itinerary: [
            {
                day: 1,
            ...
            },
            {
                ...
                description: "After breakfast we drive back to Windhoek Hosea Kutako International Airport to mark the end of the safari.",
                route: "Sesriem to Windhoek",
                highlights: "Tour ends at Windhoek Hosea Kutako International Airport",
            },
        ],
    },
    {
