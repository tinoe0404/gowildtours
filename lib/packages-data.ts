    ...
    },
    {
        ...
        itinerary: [
            ...
            },
            {
                ...
                description: "Lower Zambezi National Park is an unspoiled safari destination offering luxury experiences, incredible wildlife, greatest wilderness and breathing space. The remoteness of the Lower Zambezi is one of the biggest drawcards for most travelers as traces of people are hard to find — a rarity in the modern world. The park has big herds of elephants and buffalo, sunbathing crocodiles, sleeping lions, stealthy leopards, lively Africa wild dogs and many more. The afternoon we can do sunset boat cruise.",
            ...
            },
            {
                ...
                route: "Mana Pools to Matusadona",
                accommodation: "Spurwing Island or similar",
                meals: "LDB",
                facilities: "Double room or tent",
            ...
            },
            {
                day: 12,
                title: "Lusaka",
                description: "We drove back to Lusaka to mark the end of Safari, but en-route we stop over at Luangwa Bridge market to learn and discover local stuff we have in the area.",
